...
const translations = {
  pt: {
    ...
    dashboard: {
      ...
      sevMedio: 'Médio',
      sevBaixo: 'Baixo',
      fireVegetation: 'Fogo × Vegetação',
      fireVegetationMeta: 'Janela atual (~3 dias)',
      vegNative: 'Vegetação nativa',
      vegDeforested: 'Desmatado',
      vegRegrowth: 'Regeneração',
  ...
  en: {
    ...
    dashboard: {
      ...
      sevMedio: 'Medium',
      sevBaixo: 'Low',
      fireVegetation: 'Fire × Vegetation',
      fireVegetationMeta: 'Current window (~3 days)',
      vegNative: 'Native vegetation',
      vegDeforested: 'Deforested',
      vegRegrowth: 'Regrowth',
