...
Usage:
    python3 scripts/data/download_car_wfs.py RO              # one state
    python3 scripts/data/download_car_wfs.py RO MT PA          # several
    python3 scripts/data/download_car_wfs.py --all             # all 27 UFs
