...
Usage:
    python3 scripts/download_deter_wfs.py --days 1
    python3 scripts/download_deter_wfs.py --full                 # full history
    python3 scripts/download_deter_wfs.py --workspace deter-cerrado-nb --layer deter_cerrado --days 7
"""
import argparse
import json
import os
...
def to_sqlite(features: list, db_path: str) -> int:
    ...
    for f in features:
        ...
        rows.append((
            ...
            _num(props.get("areatotalkm")), props.get("uc") or None,
