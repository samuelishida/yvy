...
Usage:
    python3 scripts/resolve_car_document.py --cpf 12345678901
    python3 scripts/resolve_car_document.py --cnpj 12345678000199
    python3 scripts/resolve_car_document.py --sncr 1234567
    python3 scripts/resolve_car_document.py --matricula 12345
