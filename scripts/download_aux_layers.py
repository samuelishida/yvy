...
Usage:
    python3 scripts/download_aux_layers.py                      # default biomes amz+cerrado
    python3 scripts/download_aux_layers.py --biomes amz cerrado caatinga
    python3 scripts/download_aux_layers.py --workspace auxiliary-data --layer municipalities_amz
"""
import argparse
import json
import os
