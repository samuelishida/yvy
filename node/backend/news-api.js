...
async function fetchAndSaveNews() {
  try {
    ...
    const response = await newsapi.v2.everything({
      q: 'environment OR sustainability OR ecology OR "climate change" OR biodiversity OR meio ambiente OR sustentabilidade OR ecologia OR "mudanças climáticas" OR biodiversidade',
      language: 'pt',
      sortBy: 'publishedAt',
      pageSize: 50,
